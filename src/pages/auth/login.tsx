...
const Login = () => {
  return (
    <div className="h-screen w-full bg-white">
      <div className="flex flex-col items-center justify-center px-4 py-10 sm:px-6 lg:px-20 h-full">
        {/* Branding */}
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold sm:text-3xl md:text-4xl">LOGIN</h2>
        ...
        <div className="w-full">
          <Link
            to=""
            className="flex h-12 w-full items-center justify-center rounded-full border border-gray-300 bg-white shadow-sm hover:bg-gray-100 transition"
          >
            <Chrome className="mr-2 h-5 w-5" />
            <span className="text-sm font-medium">Login with <strong>Google</strong></span>
          </Link>
        </div>
        ...
        {/* Submit Button */}
          <button className="h-12 w-full rounded-full bg-primary px-5 text-white shadow-sm hover:bg-primary/90 transition">
            Login
          </button>
